...
exports.isAdmin = exports.checkUserRoleAuthorization = exports.ChatiumUserRole = void 0;
...
function checkUserRoleAuthorization(ctx, allowedRoles) {
    if (ctx.user) {
        ...
        throw new errors_1.AccessDeniedError(`ACCESS DENIED: Current user [${ctx.user.id}] doesn't have ` + `required role(s): ${allowedRoles}`);
    }
    else {
        return ctx;
    }
